...
function FaceMain() {
  ...
  return (
    <div className="h-screen">
      ...
      {coordinates && (
        <div>
          <p>Promedio X: {coordinates.promedio_x}</p>
          <p>Promedio Y: {coordinates.promedio_y}</p>
          <p>Promedio Z: {coordinates.promedio_z}</p>
          <p>Coordenadas: {coordinates.coordenadas}</p>
        </div>
      )}
    </div>
  );
